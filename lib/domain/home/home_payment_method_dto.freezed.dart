...
part of 'home_payment_method_dto.dart';
...
/// Create a copy of HomePaymentMethodDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HomePaymentMethodDtoCopyWith<HomePaymentMethodDto> get copyWith => _$HomePaymentMethodDtoCopyWithImpl<HomePaymentMethodDto>(this as HomePaymentMethodDto, _$identity);

  /// Serializes this HomePaymentMethodDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomePaymentMethodDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
@override
String toString() {
  return 'HomePaymentMethodDto(success: $success, statusCode: $statusCode, message: $message, data: $data, timeStamp: $timeStamp, version: $version)';
}
...
/// @nodoc
abstract mixin class $HomePaymentMethodDtoCopyWith<$Res>  {
  factory $HomePaymentMethodDtoCopyWith(HomePaymentMethodDto value, $Res Function(HomePaymentMethodDto) _then) = _$HomePaymentMethodDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$HomePaymentMethodDtoCopyWithImpl<$Res>
    implements $HomePaymentMethodDtoCopyWith<$Res> {
  _$HomePaymentMethodDtoCopyWithImpl(this._self, this._then);

  final HomePaymentMethodDto _self;
  final $Res Function(HomePaymentMethodDto) _then;
...
/// Adds pattern-matching-related methods to [HomePaymentMethodDto].
extension HomePaymentMethodDtoPatterns on HomePaymentMethodDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HomePaymentMethodDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HomePaymentMethodDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HomePaymentMethodDto value)  $default,){
final _that = this;
switch (_that) {
case _HomePaymentMethodDto():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HomePaymentMethodDto value)?  $default,){
final _that = this;
switch (_that) {
case _HomePaymentMethodDto() when $default != null:
return $default(_that);case _:
...
class _HomePaymentMethodDto implements HomePaymentMethodDto {
  const _HomePaymentMethodDto({@JsonKey(name: "success") this.success, @JsonKey(name: "status_code") this.statusCode, @JsonKey(name: "message") this.message, @JsonKey(name: "data") this.data, @JsonKey(name: "time_stamp") this.timeStamp, @JsonKey(name: "version") this.version});
  factory _HomePaymentMethodDto.fromJson(Map<String, dynamic> json) => _$HomePaymentMethodDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$HomePaymentMethodDtoCopyWith<_HomePaymentMethodDto> get copyWith => __$HomePaymentMethodDtoCopyWithImpl<_HomePaymentMethodDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HomePaymentMethodDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomePaymentMethodDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
/// @nodoc
abstract mixin class _$HomePaymentMethodDtoCopyWith<$Res> implements $HomePaymentMethodDtoCopyWith<$Res> {
  factory _$HomePaymentMethodDtoCopyWith(_HomePaymentMethodDto value, $Res Function(_HomePaymentMethodDto) _then) = __$HomePaymentMethodDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "success") String? success,@JsonKey(name: "status_code") int? statusCode,@JsonKey(name: "message") String? message,@JsonKey(name: "data") Data? data,@JsonKey(name: "time_stamp") DateTime? timeStamp,@JsonKey(name: "version") String? version
});
...
/// @nodoc
class __$HomePaymentMethodDtoCopyWithImpl<$Res>
    implements _$HomePaymentMethodDtoCopyWith<$Res> {
  __$HomePaymentMethodDtoCopyWithImpl(this._self, this._then);

  final _HomePaymentMethodDto _self;
  final $Res Function(_HomePaymentMethodDto) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? statusCode = freezed,Object? message = freezed,Object? data = freezed,Object? timeStamp = freezed,Object? version = freezed,}) {
  return _then(_HomePaymentMethodDto(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as String?,statusCode: freezed == statusCode ? _self.statusCode : statusCode // ignore: cast_nullable_to_non_nullable
as int?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: "payment_modes") List<PaymentMode>? get paymentModes;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Data&&const DeepCollectionEquality().equals(other.paymentModes, paymentModes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(paymentModes));

@override
String toString() {
  return 'Data(paymentModes: $paymentModes)';
}
...
@useResult
$Res call({
@JsonKey(name: "payment_modes") List<PaymentMode>? paymentModes
});
...
/// Create a copy of Data
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? paymentModes = freezed,}) {
  return _then(_self.copyWith(
paymentModes: freezed == paymentModes ? _self.paymentModes : paymentModes // ignore: cast_nullable_to_non_nullable
as List<PaymentMode>?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "payment_modes")  List<PaymentMode>? paymentModes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Data() when $default != null:
return $default(_that.paymentModes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "payment_modes")  List<PaymentMode>? paymentModes)  $default,) {final _that = this;
switch (_that) {
case _Data():
return $default(_that.paymentModes);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "payment_modes")  List<PaymentMode>? paymentModes)?  $default,) {final _that = this;
switch (_that) {
case _Data() when $default != null:
return $default(_that.paymentModes);case _:
  return null;
...
class _Data implements Data {
  const _Data({@JsonKey(name: "payment_modes") final  List<PaymentMode>? paymentModes}): _paymentModes = paymentModes;
  factory _Data.fromJson(Map<String, dynamic> json) => _$DataFromJson(json);

 final  List<PaymentMode>? _paymentModes;
@override@JsonKey(name: "payment_modes") List<PaymentMode>? get paymentModes {
  final value = _paymentModes;
  if (value == null) return null;
  if (_paymentModes is EqualUnmodifiableListView) return _paymentModes;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data&&const DeepCollectionEquality().equals(other._paymentModes, _paymentModes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_paymentModes));
...
/// Create a copy of Data
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? paymentModes = freezed,}) {
  return _then(_Data(
paymentModes: freezed == paymentModes ? _self._paymentModes : paymentModes // ignore: cast_nullable_to_non_nullable
as List<PaymentMode>?,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaymentMode&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'PaymentMode(code: $code, name: $name)';
}
...
class _PaymentMode implements PaymentMode {
  const _PaymentMode({@JsonKey(name: "code") this.code, @JsonKey(name: "name") this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaymentMode&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name));
}
