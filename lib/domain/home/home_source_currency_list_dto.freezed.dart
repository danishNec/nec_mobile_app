...
part of 'home_source_currency_list_dto.dart';
...
/// @nodoc
mixin _$HomeSourceCurrencyListDto {
...
/// Create a copy of HomeSourceCurrencyListDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HomeSourceCurrencyListDtoCopyWith<HomeSourceCurrencyListDto> get copyWith => _$HomeSourceCurrencyListDtoCopyWithImpl<HomeSourceCurrencyListDto>(this as HomeSourceCurrencyListDto, _$identity);

  /// Serializes this HomeSourceCurrencyListDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeSourceCurrencyListDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
@override
String toString() {
  return 'HomeSourceCurrencyListDto(success: $success, statusCode: $statusCode, message: $message, data: $data, timeStamp: $timeStamp, version: $version)';
}
...
/// @nodoc
abstract mixin class $HomeSourceCurrencyListDtoCopyWith<$Res>  {
  factory $HomeSourceCurrencyListDtoCopyWith(HomeSourceCurrencyListDto value, $Res Function(HomeSourceCurrencyListDto) _then) = _$HomeSourceCurrencyListDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$HomeSourceCurrencyListDtoCopyWithImpl<$Res>
    implements $HomeSourceCurrencyListDtoCopyWith<$Res> {
  _$HomeSourceCurrencyListDtoCopyWithImpl(this._self, this._then);

  final HomeSourceCurrencyListDto _self;
  final $Res Function(HomeSourceCurrencyListDto) _then;
...
/// Adds pattern-matching-related methods to [HomeSourceCurrencyListDto].
extension HomeSourceCurrencyListDtoPatterns on HomeSourceCurrencyListDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HomeSourceCurrencyListDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HomeSourceCurrencyListDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HomeSourceCurrencyListDto value)  $default,){
final _that = this;
switch (_that) {
case _HomeSourceCurrencyListDto():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HomeSourceCurrencyListDto value)?  $default,){
final _that = this;
switch (_that) {
case _HomeSourceCurrencyListDto() when $default != null:
return $default(_that);case _:
...
class _HomeSourceCurrencyListDto implements HomeSourceCurrencyListDto {
  const _HomeSourceCurrencyListDto({@JsonKey(name: "success") this.success, @JsonKey(name: "status_code") this.statusCode, @JsonKey(name: "message") this.message, @JsonKey(name: "data") this.data, @JsonKey(name: "time_stamp") this.timeStamp, @JsonKey(name: "version") this.version});
  factory _HomeSourceCurrencyListDto.fromJson(Map<String, dynamic> json) => _$HomeSourceCurrencyListDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$HomeSourceCurrencyListDtoCopyWith<_HomeSourceCurrencyListDto> get copyWith => __$HomeSourceCurrencyListDtoCopyWithImpl<_HomeSourceCurrencyListDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HomeSourceCurrencyListDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeSourceCurrencyListDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
/// @nodoc
abstract mixin class _$HomeSourceCurrencyListDtoCopyWith<$Res> implements $HomeSourceCurrencyListDtoCopyWith<$Res> {
  factory _$HomeSourceCurrencyListDtoCopyWith(_HomeSourceCurrencyListDto value, $Res Function(_HomeSourceCurrencyListDto) _then) = __$HomeSourceCurrencyListDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "success") String? success,@JsonKey(name: "status_code") int? statusCode,@JsonKey(name: "message") String? message,@JsonKey(name: "data") Data? data,@JsonKey(name: "time_stamp") DateTime? timeStamp,@JsonKey(name: "version") String? version
});
...
/// @nodoc
class __$HomeSourceCurrencyListDtoCopyWithImpl<$Res>
    implements _$HomeSourceCurrencyListDtoCopyWith<$Res> {
  __$HomeSourceCurrencyListDtoCopyWithImpl(this._self, this._then);

  final _HomeSourceCurrencyListDto _self;
  final $Res Function(_HomeSourceCurrencyListDto) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? statusCode = freezed,Object? message = freezed,Object? data = freezed,Object? timeStamp = freezed,Object? version = freezed,}) {
  return _then(_HomeSourceCurrencyListDto(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as String?,statusCode: freezed == statusCode ? _self.statusCode : statusCode // ignore: cast_nullable_to_non_nullable
as int?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eId,currencyCode,currencyName,countryCode,countryName,flagUrl,rate,status);

@override
String toString() {
  return 'CurrencyList(eId: $eId, currencyCode: $currencyCode, currencyName: $currencyName, countryCode: $countryCode, countryName: $countryName, flagUrl: $flagUrl, rate: $rate, status: $status)';
}
...
/// Create a copy of CurrencyList
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eId = freezed,Object? currencyCode = freezed,Object? currencyName = freezed,Object? countryCode = freezed,Object? countryName = freezed,Object? flagUrl = freezed,Object? rate = freezed,Object? status = freezed,}) {
  return _then(_self.copyWith(
...
/// Create a copy of CurrencyList
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eId = freezed,Object? currencyCode = freezed,Object? currencyName = freezed,Object? countryCode = freezed,Object? countryName = freezed,Object? flagUrl = freezed,Object? rate = freezed,Object? status = freezed,}) {
