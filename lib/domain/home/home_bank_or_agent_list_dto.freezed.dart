...
part of 'home_bank_or_agent_list_dto.dart';
...
/// @nodoc
mixin _$HomeBankOrAgentListDto {
...
/// Create a copy of HomeBankOrAgentListDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HomeBankOrAgentListDtoCopyWith<HomeBankOrAgentListDto> get copyWith => _$HomeBankOrAgentListDtoCopyWithImpl<HomeBankOrAgentListDto>(this as HomeBankOrAgentListDto, _$identity);

  /// Serializes this HomeBankOrAgentListDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeBankOrAgentListDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
@override
String toString() {
  return 'HomeBankOrAgentListDto(success: $success, statusCode: $statusCode, message: $message, data: $data, timeStamp: $timeStamp, version: $version)';
}
...
/// @nodoc
abstract mixin class $HomeBankOrAgentListDtoCopyWith<$Res>  {
  factory $HomeBankOrAgentListDtoCopyWith(HomeBankOrAgentListDto value, $Res Function(HomeBankOrAgentListDto) _then) = _$HomeBankOrAgentListDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$HomeBankOrAgentListDtoCopyWithImpl<$Res>
    implements $HomeBankOrAgentListDtoCopyWith<$Res> {
  _$HomeBankOrAgentListDtoCopyWithImpl(this._self, this._then);

  final HomeBankOrAgentListDto _self;
  final $Res Function(HomeBankOrAgentListDto) _then;
...
/// Adds pattern-matching-related methods to [HomeBankOrAgentListDto].
extension HomeBankOrAgentListDtoPatterns on HomeBankOrAgentListDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HomeBankOrAgentListDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HomeBankOrAgentListDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HomeBankOrAgentListDto value)  $default,){
final _that = this;
switch (_that) {
case _HomeBankOrAgentListDto():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HomeBankOrAgentListDto value)?  $default,){
final _that = this;
switch (_that) {
case _HomeBankOrAgentListDto() when $default != null:
return $default(_that);case _:
...
class _HomeBankOrAgentListDto implements HomeBankOrAgentListDto {
  const _HomeBankOrAgentListDto({@JsonKey(name: "success") this.success, @JsonKey(name: "status_code") this.statusCode, @JsonKey(name: "message") this.message, @JsonKey(name: "data") this.data, @JsonKey(name: "time_stamp") this.timeStamp, @JsonKey(name: "version") this.version});
  factory _HomeBankOrAgentListDto.fromJson(Map<String, dynamic> json) => _$HomeBankOrAgentListDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$HomeBankOrAgentListDtoCopyWith<_HomeBankOrAgentListDto> get copyWith => __$HomeBankOrAgentListDtoCopyWithImpl<_HomeBankOrAgentListDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HomeBankOrAgentListDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeBankOrAgentListDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
/// @nodoc
abstract mixin class _$HomeBankOrAgentListDtoCopyWith<$Res> implements $HomeBankOrAgentListDtoCopyWith<$Res> {
  factory _$HomeBankOrAgentListDtoCopyWith(_HomeBankOrAgentListDto value, $Res Function(_HomeBankOrAgentListDto) _then) = __$HomeBankOrAgentListDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "success") String? success,@JsonKey(name: "status_code") int? statusCode,@JsonKey(name: "message") String? message,@JsonKey(name: "data") Data? data,@JsonKey(name: "time_stamp") DateTime? timeStamp,@JsonKey(name: "version") String? version
});
...
/// @nodoc
class __$HomeBankOrAgentListDtoCopyWithImpl<$Res>
    implements _$HomeBankOrAgentListDtoCopyWith<$Res> {
  __$HomeBankOrAgentListDtoCopyWithImpl(this._self, this._then);

  final _HomeBankOrAgentListDto _self;
  final $Res Function(_HomeBankOrAgentListDto) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? statusCode = freezed,Object? message = freezed,Object? data = freezed,Object? timeStamp = freezed,Object? version = freezed,}) {
  return _then(_HomeBankOrAgentListDto(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as String?,statusCode: freezed == statusCode ? _self.statusCode : statusCode // ignore: cast_nullable_to_non_nullable
as int?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
