...
part of 'home_transfer_type_dto.dart';
...
/// Create a copy of HomeTransferTypeDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HomeTransferTypeDtoCopyWith<HomeTransferTypeDto> get copyWith => _$HomeTransferTypeDtoCopyWithImpl<HomeTransferTypeDto>(this as HomeTransferTypeDto, _$identity);

  /// Serializes this HomeTransferTypeDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeTransferTypeDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
@override
String toString() {
  return 'HomeTransferTypeDto(success: $success, statusCode: $statusCode, message: $message, data: $data, timeStamp: $timeStamp, version: $version)';
}
...
/// @nodoc
abstract mixin class $HomeTransferTypeDtoCopyWith<$Res>  {
  factory $HomeTransferTypeDtoCopyWith(HomeTransferTypeDto value, $Res Function(HomeTransferTypeDto) _then) = _$HomeTransferTypeDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$HomeTransferTypeDtoCopyWithImpl<$Res>
    implements $HomeTransferTypeDtoCopyWith<$Res> {
  _$HomeTransferTypeDtoCopyWithImpl(this._self, this._then);

  final HomeTransferTypeDto _self;
  final $Res Function(HomeTransferTypeDto) _then;
...
/// Adds pattern-matching-related methods to [HomeTransferTypeDto].
extension HomeTransferTypeDtoPatterns on HomeTransferTypeDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HomeTransferTypeDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HomeTransferTypeDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HomeTransferTypeDto value)  $default,){
final _that = this;
switch (_that) {
case _HomeTransferTypeDto():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HomeTransferTypeDto value)?  $default,){
final _that = this;
switch (_that) {
case _HomeTransferTypeDto() when $default != null:
return $default(_that);case _:
...
class _HomeTransferTypeDto implements HomeTransferTypeDto {
  const _HomeTransferTypeDto({@JsonKey(name: "success") this.success, @JsonKey(name: "status_code") this.statusCode, @JsonKey(name: "message") this.message, @JsonKey(name: "data") this.data, @JsonKey(name: "time_stamp") this.timeStamp, @JsonKey(name: "version") this.version});
  factory _HomeTransferTypeDto.fromJson(Map<String, dynamic> json) => _$HomeTransferTypeDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$HomeTransferTypeDtoCopyWith<_HomeTransferTypeDto> get copyWith => __$HomeTransferTypeDtoCopyWithImpl<_HomeTransferTypeDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HomeTransferTypeDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeTransferTypeDto&&(identical(other.success, success) || other.success == success)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp)&&(identical(other.version, version) || other.version == version));
}
...
/// @nodoc
abstract mixin class _$HomeTransferTypeDtoCopyWith<$Res> implements $HomeTransferTypeDtoCopyWith<$Res> {
  factory _$HomeTransferTypeDtoCopyWith(_HomeTransferTypeDto value, $Res Function(_HomeTransferTypeDto) _then) = __$HomeTransferTypeDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "success") String? success,@JsonKey(name: "status_code") int? statusCode,@JsonKey(name: "message") String? message,@JsonKey(name: "data") Data? data,@JsonKey(name: "time_stamp") DateTime? timeStamp,@JsonKey(name: "version") String? version
});
...
/// @nodoc
class __$HomeTransferTypeDtoCopyWithImpl<$Res>
    implements _$HomeTransferTypeDtoCopyWith<$Res> {
  __$HomeTransferTypeDtoCopyWithImpl(this._self, this._then);

  final _HomeTransferTypeDto _self;
  final $Res Function(_HomeTransferTypeDto) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? statusCode = freezed,Object? message = freezed,Object? data = freezed,Object? timeStamp = freezed,Object? version = freezed,}) {
  return _then(_HomeTransferTypeDto(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as String?,statusCode: freezed == statusCode ? _self.statusCode : statusCode // ignore: cast_nullable_to_non_nullable
as int?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
