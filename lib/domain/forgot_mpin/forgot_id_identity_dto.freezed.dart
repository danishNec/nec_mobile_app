...
/// @nodoc
mixin _$ForgotIdIdentityDto {

@JsonKey(name: "success") String? get success;@JsonKey(name: "data") Data? get data;
/// Create a copy of ForgotIdIdentityDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ForgotIdIdentityDtoCopyWith<ForgotIdIdentityDto> get copyWith => _$ForgotIdIdentityDtoCopyWithImpl<ForgotIdIdentityDto>(this as ForgotIdIdentityDto, _$identity);

  /// Serializes this ForgotIdIdentityDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForgotIdIdentityDto&&(identical(other.success, success) || other.success == success)&&(identical(other.data, data) || other.data == data));
}
...
@override
String toString() {
  return 'ForgotIdIdentityDto(success: $success, data: $data)';
}
...
/// @nodoc
abstract mixin class $ForgotIdIdentityDtoCopyWith<$Res>  {
  factory $ForgotIdIdentityDtoCopyWith(ForgotIdIdentityDto value, $Res Function(ForgotIdIdentityDto) _then) = _$ForgotIdIdentityDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ForgotIdIdentityDtoCopyWithImpl<$Res>
    implements $ForgotIdIdentityDtoCopyWith<$Res> {
  _$ForgotIdIdentityDtoCopyWithImpl(this._self, this._then);

  final ForgotIdIdentityDto _self;
  final $Res Function(ForgotIdIdentityDto) _then;
...
/// Adds pattern-matching-related methods to [ForgotIdIdentityDto].
extension ForgotIdIdentityDtoPatterns on ForgotIdIdentityDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ForgotIdIdentityDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ForgotIdIdentityDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ForgotIdIdentityDto value)  $default,){
final _that = this;
switch (_that) {
case _ForgotIdIdentityDto():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ForgotIdIdentityDto value)?  $default,){
final _that = this;
switch (_that) {
case _ForgotIdIdentityDto() when $default != null:
return $default(_that);case _:
...
class _ForgotIdIdentityDto implements ForgotIdIdentityDto {
  const _ForgotIdIdentityDto({@JsonKey(name: "success") this.success, @JsonKey(name: "data") this.data});
  factory _ForgotIdIdentityDto.fromJson(Map<String, dynamic> json) => _$ForgotIdIdentityDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$ForgotIdIdentityDtoCopyWith<_ForgotIdIdentityDto> get copyWith => __$ForgotIdIdentityDtoCopyWithImpl<_ForgotIdIdentityDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ForgotIdIdentityDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ForgotIdIdentityDto&&(identical(other.success, success) || other.success == success)&&(identical(other.data, data) || other.data == data));
}
...
/// @nodoc
abstract mixin class _$ForgotIdIdentityDtoCopyWith<$Res> implements $ForgotIdIdentityDtoCopyWith<$Res> {
  factory _$ForgotIdIdentityDtoCopyWith(_ForgotIdIdentityDto value, $Res Function(_ForgotIdIdentityDto) _then) = __$ForgotIdIdentityDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "success") String? success,@JsonKey(name: "data") Data? data
});
...
/// @nodoc
class __$ForgotIdIdentityDtoCopyWithImpl<$Res>
    implements _$ForgotIdIdentityDtoCopyWith<$Res> {
  __$ForgotIdIdentityDtoCopyWithImpl(this._self, this._then);

  final _ForgotIdIdentityDto _self;
  final $Res Function(_ForgotIdIdentityDto) _then;

/// Create a copy of ForgotIdIdentityDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? data = freezed,}) {
  return _then(_ForgotIdIdentityDto(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as String?,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as Data?,
  ));
